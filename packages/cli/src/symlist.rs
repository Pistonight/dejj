...
use crate::{config::CfgCsv, demangler::Demangler};
...
impl SymbolList {
    ...
    pub async fn load_func(&mut self, config: &CfgCsv, demangler: Arc<Demangler>) -> cu::Result<()> {
...
pub fn load_symbol_csv(config: &CfgCsv) -> cu::Result<BTreeMap<String, u32>> {
